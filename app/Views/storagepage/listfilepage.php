        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <h6 class="text-uppercase">List Storage <br><?php echo $datausers['username'] ?> </h6>
              <button class="btn btn-primary btn-sm ms-auto"><a href="<?= base_url('storage').'/uploadpage' ?>">Upload File</a></button>
            </div>
            </div>
            <?php
