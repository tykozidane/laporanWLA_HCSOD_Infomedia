...
<head>
  ...
  <title>
    HC Applications - Approval Dokumen
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="../pages/agreement.html">
       ...
       <li class="nav-item">
		...
		<li class="nav-item">
          <a class="nav-link" href="../pages/DMS.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Agreement Digital</h6>
			</div>
             <div class="ms-md-auto pe-md-3 d-flex align-items-center">
              <div class="input-group">
                <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                <input type="text" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="Type here...">
				<!--<a class="btn bg-gradient-dark mb-0" href="../pages/create_agreement.html"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Document</a>-->           
				<a class="btn bg-gradient-info mb-0" href="<?= base_url('/addnewdata/employee') ?>"><i class="fas fa-link"></i>&nbsp;&nbsp;Shared Link</a>             
			 </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nomor KTP</th>
                  ...
                  <tbody>
                    <?php foreach($listagreement as $x){
                        foreach($data as $y){
                            if($x['no_ktp'] == $y['no_ktp']){
                        ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?= $y['nama_emp'] ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?= $y['no_ktp'] ?></p>
                      </td>
                   <td class="align-middle text-center text-sm">
                        <span class="badge bg-secondary"><?= $x['status'] ?></span>
                      </td>
					  <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?= $x['update_at'] ?></span>
                      </td>
