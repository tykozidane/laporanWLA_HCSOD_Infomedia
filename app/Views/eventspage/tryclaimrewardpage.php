      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Masukan NIK Anda</h1>
            <p class="text-lead text-white">Kami akan mengirimkan Link ke email anda</p>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="card mb-4">
              ...
              <div class="card-body px-5 pt-0 pb-2">
                <div class="input-group">
                  ...
                  <button type="submit"><span type="button" class="btn bg-gradient-dark mb-0">Submit</span></button>
                </div>
              </div>
              <?= form_close(); ?>
