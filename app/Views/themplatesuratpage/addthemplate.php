...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Add Themplate</h6>
        </nav>
  ...
  <div class="card-body">
    ...
    <?= form_open_multipart('themplate/add/savetext') ?> 
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="kategori" name="kategori" aria-label="Default select example" required>
            ...
            <option value="pkwtjib">PKWT JIB</option>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea id="summernote" name="judul"></textarea>
        <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea id="summernote3" name="tandatangan"></textarea>
        <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
    </div>
      </div>
      <div class="form-group row">
        <div class="col-sm">
          <button type="submit" class="btn btn-success">Save New Data Themplate</button>
        </div>
      </div>
    <?= form_close(); ?>
  </div>
